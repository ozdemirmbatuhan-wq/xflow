...
& (Join-Path $PSScriptRoot "prepare_flow5_windows.ps1") `
    -Flow5Source $Flow5Source -OccRoot $OccRoot -GmshRoot $GmshRoot `
...
cmake -S (Join-Path $repositoryRoot "flow5_bridge") -B $BridgeBuild `
